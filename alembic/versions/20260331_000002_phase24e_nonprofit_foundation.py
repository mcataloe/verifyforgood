"""Phase 24E nonprofit relational schema foundation
...
def upgrade() -> None:
    op.create_table(
        "nonprofits",
        sa.Column("nonprofit_id", sa.String(length=64), primary_key=True, nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("nonprofit_id", sa.String(length=64), nullable=False),
