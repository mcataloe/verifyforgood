...
from verification.backend.ingest.state.adapters.nevada.client import NevadaRegistryClient
from verification.backend.ingest.state.adapters.nevada.mapper import map_nevada_record
from verification.backend.ingest.state.adapters.new_york.client import NewYorkRegistryClient
from verification.backend.ingest.state.adapters.new_york.mapper import map_new_york_record
from verification.backend.ingest.state.adapters.ohio.client import OhioRegistryClient
from verification.backend.ingest.state.adapters.ohio.mapper import map_ohio_record
from verification.backend.ingest.state.adapters.south_dakota.client import SouthDakotaRegistryClient
from verification.backend.ingest.state.adapters.south_dakota.mapper import map_south_dakota_record
from verification.backend.ingest.state.adapters.utah.client import UtahRegistryClient
from verification.backend.ingest.state.adapters.utah.mapper import map_utah_record
