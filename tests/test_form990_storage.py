...
from infrastructure.charity_status.form990.storage import checkpoint_key, discovery_manifest_key, filing_manifest_key, manifest_key, normalized_metadata_key, raw_xml_key, state_manifest_key
...
def test_storage_key_generation_is_stable():
    ...
    assert discovery_manifest_key("form990/normalized/manifests/", "run1", "2024", "archive.csv") == "form990/normalized/manifests/discovery/run1/2024/archive.csv.json"
