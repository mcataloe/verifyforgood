...
from verification.backend.ingest.federal.form990.storage import (
    checkpoint_key,
    discovery_diff_key,
...
def test_storage_key_generation_is_stable():
    ...
    assert discovery_state_key("form990/normalized/manifests/") == "form990/normalized/manifests/discovery/state/latest_sources.json"
