...
from verification.sources.models import ProviderCapability, SourceCategory, SourceMetadata
    ...
    def to_dict(self) -> dict[str, object]:
        return {
            ...
            "provider_capabilities": [
                capability.to_dict()
                for capability in sorted(self._capabilities.values(), key=lambda item: item.provider_name)
            ],
        }
