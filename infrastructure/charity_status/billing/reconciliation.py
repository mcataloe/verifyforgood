...
from charity_status.billing.checkout import BillingConflictError, BillingEligibilityError, BillingNotEnabledError, StripeCheckoutConfig, _clean_text
from charity_status.billing.plan_changes import HttpStripePlanChangeClient, StripeSubscriptionSnapshot
...
class HttpStripeSubscriptionLookupClient(HttpStripePlanChangeClient):
    ...
    def _snapshot_from_payload(payload: dict[str, Any]) -> StripeSubscriptionSnapshot:
        from charity_status.billing.plan_changes import _subscription_snapshot_from_response
