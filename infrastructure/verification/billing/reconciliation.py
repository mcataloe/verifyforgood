...
from verification.billing.checkout import BillingConflictError, BillingEligibilityError, BillingNotEnabledError, StripeCheckoutConfig, _clean_text
from verification.billing.plan_changes import HttpStripePlanChangeClient, StripeSubscriptionSnapshot
from verification.billing.service import EntitlementService
from verification.billing.trials import TrialLifecycleService
...
class HttpStripeSubscriptionLookupClient(HttpStripePlanChangeClient):
    ...
    def _snapshot_from_payload(payload: dict[str, Any]) -> StripeSubscriptionSnapshot:
        from verification.billing.plan_changes import _subscription_snapshot_from_response
