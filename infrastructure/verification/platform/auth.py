...
from verification.auth.models import AuthenticatedPrincipal
from verification.billing import EntitlementService
from verification.billing.service import DEFAULT_PLANS, check_quota_and_calculate, monthly_period_for
from verification.core.models import AuthContext
from verification_platform.customer_accounts import usage_metrics_for_route
...
class OAuthClientCredentialsService:
    ...
    def issue_token(self, client_id: str, client_secret: str) -> tuple[AuthContext, dict[str, Any]]:
        ...
        from verification.auth.oauth import issue_client_access_token
...
def load_oauth_token_store(raw_json: str) -> StaticOAuthTokenStore:
    ...
    records = []
    from verification.auth.oauth import StoredOAuthTokenRecord
...
def _from_context(auth_context: AuthContext) -> AuthenticatedPrincipal:
    from verification.auth.models import AuthenticatedPrincipal, ApiPlan
