...
const plans = [
  {
    name: "Free",
    summary: "Entry point for nonprofit verification and light evaluation workflows.",
  ...
  },
  {
    ...
    details: "10,000 monthly requests with benchmarking and batch verification.",
  },
  {
    name: "Pro / Enterprise",
    summary: "For higher-scale monitoring, settings, and state-registry heavy workflows.",
    details: "Higher throughput, broader capabilities, and room for account-level controls.",
  },
];
    ...
    <Grid className="marketing-page-grid">
      <Panel title="Pricing posture" subtitle="This repo models plans and capabilities without publishing final public prices here.">
        <p>
          ...
          hosted billing flows without hardcoding pricing details that may change outside the repo.
        </p>
      </Panel>
