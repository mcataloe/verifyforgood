    ...
    <Grid className="marketing-page-grid">
      <Panel title="Core product story" subtitle="Deliberate placeholders for future richer content blocks.">
        <ul className="marketing-list">
          ...
          <li>Source inspection for filings, compliance, and provenance-sensitive workflows.</li>
          <li>Batch and premium capabilities that expand with plan entitlements.</li>
        </ul>
      </Panel>

      <Panel title="Likely future expansions" subtitle="Kept local to marketing until reuse is proven.">
        <ul className="marketing-list">
