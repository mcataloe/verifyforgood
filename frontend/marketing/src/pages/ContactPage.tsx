  ...
  return (
    <Grid className="marketing-page-grid">
      <Panel
        ...
        subtitle="This area should support both sales motion and self-serve conversion."
      >
        <ul className="marketing-list">
          <li>Future demo request flow.</li>
          <li>Support and trust escalation path.</li>
          <li>
            Conversion handoff into trial, pricing, and developer onboarding
            journeys.
          </li>
        </ul>
      </Panel>
      ...
      <Panel
        ...
        subtitle="Not choosing a CMS, CRM, or form workflow yet."
      >
        <ul className="marketing-list">
