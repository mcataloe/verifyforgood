  ...
  return (
    <Grid className="docs-page-grid">
      <Panel
        ...
        subtitle="A docs-first view of the existing contract."
      >
        <ul className="docs-list">
          <li>
            All current customer routes are versioned under `/
            {runtimeConfig.apiVersion}`.
          </li>
          <li>
            Customer access is modeled through API keys and OAuth client
            credentials.
          </li>
          <li>
            Standard responses use a consistent envelope with `data`, `meta`,
            and `errors`.
          </li>
        </ul>
      </Panel>
      ...
      <Panel
        ...
        subtitle="Useful anchors for future guides and examples."
      >
        <ul className="docs-list">
          <li>
