...
export const docsRoutes: DocsRouteDefinition[] = [
  {
    ...
    description:
      "High-level onboarding for customers and developers entering the product for the first time.",
  },
  {
    ...
    description:
      "Core capability map for verification, scoring, source inspection, and customer-managed settings.",
  },
  {
    key: "api-usage",
    label: "API Usage",
    hash: "#/api-usage",
    description:
      "Versioning, auth modes, and early endpoint guidance grounded in the current API contract.",
  },
  {
    key: "integrations",
    label: "Integrations",
    hash: "#/integrations",
    description:
      "Examples and reference stubs for workflow integrations such as M365 Power Automate.",
  },
  {
    key: "faq",
    label: "FAQ",
    hash: "#/faq",
    description:
      "Support-oriented answers for common adoption, billing, and platform questions.",
  },
];
