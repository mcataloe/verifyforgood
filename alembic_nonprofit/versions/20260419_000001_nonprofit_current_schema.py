"""Dedicated nonprofit database baseline schema.

Revision ID: 20260419_000001_nonprofit
Revises:
...
revision = "20260419_000001_nonprofit"
down_revision = None
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.create_table(
        "nonprofits",
        sa.Column("nonprofit_id", BIGINT_PRIMARY_KEY, sa.Identity(start=1), primary_key=True, nullable=False),
        ...
        sa.Column("ntee_category", sa.String(length=128), nullable=True),
    ...
    op.create_table(
        "nonprofit_filings",
        sa.Column("filing_id", BIGINT_PRIMARY_KEY, sa.Identity(start=1), primary_key=True, nullable=False),
    ...
    op.create_table(
        "nonprofit_sources",
        sa.Column("nonprofit_source_id", BIGINT_PRIMARY_KEY, sa.Identity(start=1), primary_key=True, nullable=False),
        sa.Column("nonprofit_id", BIGINT_FOREIGN_KEY, nullable=False),
    ...
    op.create_table(
        "compliance_checks",
        sa.Column("compliance_check_id", BIGINT_PRIMARY_KEY, sa.Identity(start=1), primary_key=True, nullable=False),
        sa.Column("nonprofit_id", BIGINT_FOREIGN_KEY, nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("raw_filing_id", BIGINT_PRIMARY_KEY, sa.Identity(start=1), primary_key=True, nullable=False),
        sa.Column("nonprofit_id", BIGINT_FOREIGN_KEY, nullable=False),
        sa.Column("filing_id", BIGINT_FOREIGN_KEY, nullable=False),
        sa.Column("tax_year", sa.Integer(), nullable=True),
        sa.Column("form_type", sa.String(length=32), nullable=False),
        sa.Column("filing_date", sa.Date(), nullable=True),
        sa.Column("source_name", sa.String(length=128), nullable=True),
        ...
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
        sa.ForeignKeyConstraint(["nonprofit_id"], ["nonprofits.nonprofit_id"], name="fk_nonprofit_raw_filings_nonprofit_id_nonprofits"),
        sa.ForeignKeyConstraint(["filing_id"], ["nonprofit_filings.filing_id"], name="fk_nonprofit_raw_filings_filing_id_nonprofit_filings"),
        sa.UniqueConstraint("filing_id", "xml_content_hash", name="uq_nonprofit_raw_filings_filing_hash"),
    )
    op.create_index("ix_nonprofit_raw_filings_nonprofit_form_year", "nonprofit_raw_filings", ["nonprofit_id", "form_type", "tax_year", "filing_date"], unique=False)
    op.create_index("ix_nonprofit_raw_filings_filing_latest", "nonprofit_raw_filings", ["filing_id", "updated_at"], unique=False)

    op.create_table(
        "form990_archives",
        sa.Column("archive_id", BIGINT_PRIMARY_KEY, sa.Identity(start=1), primary_key=True, nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("file_id", BIGINT_PRIMARY_KEY, sa.Identity(start=1), primary_key=True, nullable=False),
        sa.Column("archive_id", BIGINT_FOREIGN_KEY, nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_index("ix_compliance_checks_nonprofit_type", table_name="compliance_checks")
    op.drop_index("ix_compliance_checks_nonprofit_evaluated", table_name="compliance_checks")
    op.drop_table("compliance_checks")
    op.drop_index("ix_nonprofit_sources_nonprofit_source_id", table_name="nonprofit_sources")
    op.drop_index("ix_nonprofit_sources_nonprofit_retrieved", table_name="nonprofit_sources")
    ...
    op.drop_index("ix_nonprofits_normalized_name", table_name="nonprofits")
