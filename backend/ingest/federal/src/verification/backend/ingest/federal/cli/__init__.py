"""CLI entrypoints for backend-owned federal ingest runtimes."""
...
def _build_run_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="verification.backend.ingest.federal.cli run",
...
def _build_eo_bmf_run_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="verification.backend.ingest.federal.cli run-eo-bmf",
...
def _dispatch(command: str, event: dict[str, Any]) -> Any:
    ...
    raise ValueError(f"unsupported federal ingest command: {command}")
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(
        prog="verification.backend.ingest.federal.cli",
