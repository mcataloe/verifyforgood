...
from verification.backend.ingest.state.enums import StateRegistryStanding
...
PARSER_VERSION = "south_dakota_business_registry.v1"
SOURCE_NAME = "south_dakota_secretary_of_state"
BASE_URL = "https://sosenterprise.sd.gov"


def map_south_dakota_record(
    ...
    if standing in {None, StateRegistryStanding.UNKNOWN} and normalize_entity_name(raw_record.get("status")) in {"REVOKED", "DISSOLVED", "INACTIVE"}:
