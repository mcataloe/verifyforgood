...
from verification.backend.shared.customer_accounts.sqlalchemy_db import CustomerAccountsBase
...
class NonprofitModel(CustomerAccountsBase):
    ...
    ntee_category: Mapped[str | None] = mapped_column(String(128), nullable=True)
