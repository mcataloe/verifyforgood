...
from verification.backend.shared.customer_accounts.audit_logging import AuditRecord
from verification.backend.shared.customer_accounts.audit_repository import _audit_from_item
from verification.backend.shared.customer_accounts.dynamodb_identity import (
    _api_key_from_item,
