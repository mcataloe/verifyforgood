...
from verification.backend.shared.auth.oauth import StoredOAuthClientRecord, build_oauth_client_record
from verification.backend.shared.auth.service import StoredApiKeyRecord, build_api_key_record
from verification.backend.shared.billing import EntitlementService, Subscription
...
class ControlPlaneService:
    ...
    def _build_subscription(self, account_id: str, payload: dict[str, Any]) -> ManagedSubscription:
        ...
        return ManagedSubscription(
            ...
            grace_period_ends_at=current.grace_period_ends_at if current else None,
