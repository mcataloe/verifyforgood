"""Backend-owned Form 990 worker runtime implementation.

This module is now the source of truth for queued Form 990 chunk processing.
`infrastructure.lambda_form990_worker` remains only as a thin compatibility
adapter.
"""
