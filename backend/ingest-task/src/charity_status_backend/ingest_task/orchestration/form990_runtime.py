"""Backend-owned Form 990 ingest runtime implementation.

This module is now the source of truth for the Form 990 Lambda-style ingest
runtime. `infrastructure.lambda_form990` remains only as a thin compatibility
adapter.
"""
